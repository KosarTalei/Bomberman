...
public class BomberMan extends Application {
    ...
    private Parent createContent() {
        ...
        try(InputStream is = Files.newInputStream(Paths.get("Resources/BomberMenu/Background.jpg"))){
        ...
        MenuItem m1 = new MenuItem("1 PLAYER GAME");
    ...
    private class MenuItem extends StackPane {
        ...
        public MenuItem(String name) {
            ...
            setOnMousePressed(event -> {
                ...
                Sandbox.setupScene();
                Scene scene = Sandbox.getScene();

                //Stage stage = BomberMan.getStage();
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        primaryStage.setTitle("BOMBER MAN GAME");
